	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder columns-2">
			<div id="postbox-container-1" class="postbox-container">
				...
				<?php do_meta_boxes("newsletters_page_" . $this -> sections -> welcome, 'side', $post); ?>
			</div>
			<div id="postbox-container-2" class="postbox-container">
				<?php do_meta_boxes("newsletters_page_" . $this -> sections -> welcome, 'normal', $post); ?>
                <?php do_meta_boxes("newsletters_page_" . $this -> sections -> welcome, 'advanced', $post); ?>
			</div>
		</div>
	</div>
</div>