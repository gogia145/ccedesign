<div class="wrap newsletters">
	...
	<button type="button" class="button button-secondary button-small copy-button" data-clipboard-text="<?php echo $Html -> retainquery($this -> pre . 'method=offsite&form=' . $form -> id, home_url()); ?>">
		<i class="fa fa-copy fa-fw"></i>
	</button>
	...
	<button type="button" class="button button-secondary button-small copy-button" data-clipboard-text="<?php echo htmlentities(stripslashes($output)); ?>">
		<i class="fa fa-copy fa-fw"></i>
	</button>
</div>