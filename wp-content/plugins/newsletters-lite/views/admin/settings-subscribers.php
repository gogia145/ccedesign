...
<div class="wrap <?php echo $this -> pre; ?> newsletters">
	<h1><?php _e('Subscribers Configuration', 'wp-mailinglist'); ?></h1>
		...
		<div id="poststuff">
			<div id="post-body" class="metabox-holder columns-2">
				<div id="postbox-container-1" class="postbox-container">
					...
					<?php do_meta_boxes("newsletters_page_" . $this -> sections -> settings_subscribers, 'side', $post); ?>
				</div>
				<div id="postbox-container-2" class="postbox-container">
					<?php do_meta_boxes("newsletters_page_" . $this -> sections -> settings_subscribers, 'high', $post); ?>
					<?php do_meta_boxes("newsletters_page_" . $this -> sections -> settings_subscribers, 'normal', $post); ?>
                    <?php do_meta_boxes("newsletters_page_" . $this -> sections -> settings_subscribers, 'advanced', $post); ?>
				</div>
			</div>
		</div>
	</form>
