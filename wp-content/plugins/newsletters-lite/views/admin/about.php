	...
	<div class="changelog">
		...
		<div class="feature-section under-the-hood three-col">
			<div class="col">
				...
				<a href="http://tribulant.com/extensions/view/69/bloom-subscribers"><img style="float:left; margin:0 15px 10px 0;" src="<?php echo $this -> render_url('images/about/bloom-subscribers.png'); ?>" alt="bloom-subscribers" /></a>
			...
			<div class="col">
				...
				<a href="http://tribulant.com/extensions/view/68/events-manager-subscribers"><img style="float:left; margin:0 15px 10px 0;" src="<?php echo $this -> render_url('images/about/events-manager-subscribers.png'); ?>" alt="events-manager-subscribers" /></a>
			...
			<div class="col">
				...
				<a href="http://tribulant.com/extensions/view/66/profile-builder-subscribers"><img style="float:left; margin:0 15px 10px 0;" src="<?php echo $this -> render_url('images/about/profile-builder-subscribers.png'); ?>" alt="profile-builder-subscribers" /></a>
