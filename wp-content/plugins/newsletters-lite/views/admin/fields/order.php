<div class="wrap newsletters">
	<h2><?php _e('Order Custom Fields', 'wp-mailinglist'); ?></h2>
	
	<div class="subsubsub" style="float:none;"><?php echo $Html -> link(__('&larr; Manage All Fields', 'wp-mailinglist'), $this -> url); ?></div>
	<p><?php _e('Drag and drop the custom fields below to order them.', 'wp-mailinglist'); ?></p>
	...
	<?php else : ?>
		<p class="newsletters_error"><?php _e('No custom fields were found', 'wp-mailinglist'); ?></p>													
	<?php endif; ?>
</div>