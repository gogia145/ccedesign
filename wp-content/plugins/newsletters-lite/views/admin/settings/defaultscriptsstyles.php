...
<h4><?php _e('Load Default Styles', 'wp-mailinglist'); ?></h4>
<p class="howto"><?php _e('Turn On/Off the loading of default styles in the plugin.', 'wp-mailinglist'); ?></p>
	...
	<table class="widefat">
		<thead>
			<tr>
				...
				<th><?php _e('Style', 'wp-mailinglist'); ?>
		...
		<tbody>
			...
			<?php foreach ($defaultstyles as $handle => $style) : ?>
				...
				<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
					...
					<td>
						<input placeholder="<?php echo esc_attr(stripslashes(__('All posts/pages', 'wp-mailinglist'))); ?>" class="widefat" type="text" name="loadstyles_pages[<?php echo $handle; ?>]" value="<?php echo esc_attr(stripslashes($custom_pages)); ?>" id="loadstyles_pages_<?php echo $handle; ?>" />
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
...
<h4><?php _e('Load Default Scripts', 'wp-mailinglist'); ?></h4>
<p class="howto"><?php _e('Turn On/Off the loading of default scripts in the plugin.', 'wp-mailinglist'); ?></p>
	...
	<table class="widefat">
		<thead>
			<tr>
				...
				<th><?php _e('Script', 'wp-mailinglist'); ?>
		...
		<tbody>
			...
			<?php foreach ($defaultscripts as $handle => $script) : ?>
				...
				<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
					...
					<td>
						<input placeholder="<?php echo esc_attr(stripslashes(__('All posts/pages', 'wp-mailinglist'))); ?>" class="widefat" type="text" name="loadscripts_pages[<?php echo $handle; ?>]" value="<?php echo esc_attr(stripslashes($custom_pages)); ?>" id="loadscripts_pages_<?php echo $handle; ?>" />
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
