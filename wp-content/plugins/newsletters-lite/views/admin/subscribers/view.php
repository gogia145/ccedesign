<div class="wrap newsletters <?php echo $this -> pre; ?>">
	...
	<h1><?php _e('View Subscriber:', 'wp-mailinglist'); ?> <?php echo $subscriber -> email; ?></h1>
	<br class="clear" />
		...
		<tbody>
			...
			<?php if (!empty($fields)) : ?>
				<?php foreach ($fields as $field) : ?>
					<?php if (!empty($subscriber -> {$field -> slug}) || $subscriber -> {$field -> slug} == "0" || $subscriber -> {$field -> slug} != "email") : ?>
						<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
