<div class="wrap newsletters">
	...
	<div style="width:400px;">
	    ...
	    <form id="testsettingsform" onsubmit="wpml_testsettings(this); return false;" action="<?php echo home_url(); ?>/?<?php echo $this -> pre; ?>method=testsettings" method="post">    
	        ...
	        <p>
	        	<?php $_POST['subject'] = (empty($_POST['subject'])) ? __('Test Email', 'wp-mailinglist') : esc_html($_POST['subject']); ?>
	        ...
	        <p>
	        	...
	        	<?php $_POST['message'] = (empty($_POST['message'])) ? __('This is a test email sent from the Newsletter plugin.', 'wp-mailinglist') : esc_html($_POST['message']); ?>
