...
<table class="form-table">
	<tbody>
		<tr>
			<th><label for="etmessage_posts"><?php _e('Email Message', 'wp-mailinglist'); ?></label></th>
			<td>
				...
				<?php if ($posts_backup = $this -> get_option('etmessage_posts_backup')) : ?>
					...
					<textarea class="widefat" cols="100%" rows="5"><?php echo esc_attr(stripslashes($posts_backup)); ?></textarea>
				<?php endif; ?>
				...
				<div class="howto">
					...
					<code>[newsletters_post_thumbnail size="thumbnail" hspace="15" align="left"]</code> <?php _e('The thumbnail (if any) of the post with an optional "size" parameter.', 'wp-mailinglist'); ?><br/>
