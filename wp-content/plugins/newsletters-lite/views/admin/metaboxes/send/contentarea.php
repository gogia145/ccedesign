...
<p>
	<a href="" onclick="if (confirm('<?php echo __('Are you sure you want to remove this content area?', 'wp-mailinglist'); ?>')) { deletecontentarea('<?php echo $contentarea -> number; ?>', '<?php echo $contentarea -> history_id; ?>'); } return false;" class="button button-secondary"><?php _e('Delete', 'wp-mailinglist'); ?></a>
</p>
