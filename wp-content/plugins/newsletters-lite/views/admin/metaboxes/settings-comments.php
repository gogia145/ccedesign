...
<table class="form-table">
	<tbody>
    	<tr>
        	<th><label for="commentformcheckbox_Y"><?php _e('Comment Form Checkbox', 'wp-mailinglist'); ?></label></th>
            <td>
            	<label><input onclick="jQuery('#commentformcheckbox_div').show();" <?php echo ($this -> get_option('commentformcheckbox') == "Y") ? 'checked="checked"' : ''; ?> type="radio" name="commentformcheckbox" value="Y" id="commentformcheckbox_Y" /> <?php _e('Yes', 'wp-mailinglist'); ?></label>
                <label><input onclick="jQuery('#commentformcheckbox_div').hide();" <?php echo ($this -> get_option('commentformcheckbox') == "N") ? 'checked="checked"' : ''; ?> type="radio" name="commentformcheckbox" value="N" id="commentformcheckbox_N" /> <?php _e('No', 'wp-mailinglist'); ?></label>
            	<span class="howto"><?php _e('Turn this on (Yes) to display a checkbox on the WordPress comment form for commentors to subscribe to a mailing list.', 'wp-mailinglist'); ?></span>
            </td>
        </tr>
    </tbody>
</table>
...
<div id="commentformcheckbox_div" style="display:<?php echo ($this -> get_option('commentformcheckbox') == "Y") ? 'block' : 'none'; ?>;">
	<table class="form-table">
    	<tbody>
        	<tr>
            	<th><label for="commentformlist"><?php _e('Subscribe List', 'wp-mailinglist'); ?></label></th>
                <td>
                    ...
                    <?php endif; ?>
                    <span class="howto"><?php _e('Choose the list to which commentors will be subscribed when the checkbox is checked.', 'wp-mailinglist'); ?></span>
                </td>
            </tr>
        	<tr>
            	<th><label for="commentformlabel"><?php _e('Comments Checkbox Label', 'wp-mailinglist'); ?></label></th>
                <td>
                	...
                	<?php endif; ?>
                	<span class="howto"><?php _e('Type a label/caption to display for the checkbox which your commentors will see.', 'wp-mailinglist'); ?></span>
                </td>
            </tr>
            <tr>
            	<th><label for="commentformautocheck_N"><?php _e('Auto Check Checkbox', 'wp-mailinglist'); ?></label></th>
                <td>
                	<label><input <?php echo ($this -> get_option('commentformautocheck') == "Y") ? 'checked="checked"' : ''; ?> type="radio" name="commentformautocheck" value="Y" id="commentformautocheck_Y" /> <?php _e('Yes', 'wp-mailinglist'); ?></label>
                    <label><input <?php echo ($this -> get_option('commentformautocheck') == "N") ? 'checked="checked"' : ''; ?> type="radio" name="commentformautocheck" value="N" id="commentformautocheck_N" /> <?php _e('No', 'wp-mailinglist'); ?></label>
                    <span class="howto"><?php _e('automatically check the checkbox on the comment form.', 'wp-mailinglist'); ?></span>
                </td>
            </tr>
        </tbody>
    </table>
...
<table class="form-table">
	<tbody>
    	<tr>
			<th><?php _e('Registration Checkbox', 'wp-mailinglist'); ?></th>
			<td>
				...
				<?php if (empty($users_can_register) || $users_can_register == 0) : ?>
					<div class="newsletters_error"><?php _e('WordPress registration is currently deactivated', 'wp-mailinglist'); ?></div>
				<?php endif; ?>
                
                <span class="howto"><?php _e('Turn this on to place a subscribe checkbox on the registration form.', 'wp-mailinglist'); ?></span>
			</td>
		</tr>
    </tbody>
</table>
...
<div id="registercheckboxdiv" style="display:<?php echo $display = ($registercheckbox == "Y") ? 'block' : 'none'; ?>;">
	<table class="form-table">
		<tbody>
        	<tr>
            	<th><label for="registerformlabel"><?php _e('Registration Checkbox Label', 'wp-mailinglist'); ?></label></th>
                <td>
                	<?php if ($this -> language_do()) : ?>
						<?php
                	...
                	<?php endif; ?>
                    <span class="howto"><?php _e('Label/caption text next to the checkbox on the registration form.', 'wp-mailinglist'); ?></span>
                </td>
            </tr>
			<tr>
				...
				<td>
					...
					<span class="howto"><?php _e('Should the subscribe checkbox be ticked/checked by default or not?', 'wp-mailinglist'); ?></span>
				</td>
			</tr>
			<tr>
				<th><label for="<?php echo $this -> pre; ?>autosubscribelist"><?php _e('Registration List(s)', 'wp-mailinglist'); ?></label>
				...
				<td>
					...
					<?php if ($mailinglists = $Mailinglist -> select(true)) : ?>
						...
						<span class="howto"><?php _e('To which list(s) should new users be subscribed upon registration?', 'wp-mailinglist'); ?></span>
					<?php else : ?>
