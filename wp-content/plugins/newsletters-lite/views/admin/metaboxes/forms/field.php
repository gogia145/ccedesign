		...
		<tbody>
			...
			<tr>
				...
				<td>
						...
						<div id="<?php echo $field -> slug; ?>-placeholder-tabs">
							...
							<?php foreach ($languages as $language) : ?>
								<div id="<?php echo $field -> slug; ?>-placeholder-tabs-<?php echo $language; ?>">
									<input type="text" class="widefat" name="form_fields[<?php echo $field -> id; ?>][placeholder][<?php echo $language; ?>]" value="<?php echo esc_attr(stripslashes($this -> language_use($language, $form_field -> placeholder))); ?>" id="form_fields_<?php echo $field -> id; ?>_placeholder_<?php echo $language; ?>" placeholder="<?php echo esc_attr(stripslashes($this -> language_use($language, $field -> watermark))); ?>" />
								</div>
							<?php endforeach; ?>
						</div>
					...
					<?php endif; ?>
					<span class="howto"><?php _e('Placeholder/watermark to show inside this field when it is empty/blank.', 'wp-mailinglist'); ?></span>
				</td>
			</tr>
			<tr>
