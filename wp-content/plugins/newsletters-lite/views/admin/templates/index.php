<div class="wrap newsletters">
	...
	<form id="posts-filter" method="post" action="?page=<?php echo $this -> sections -> templates; ?>">
		...
		<p class="search-box">
			<input type="text" name="searchterm" value="<?php echo (!empty($_POST['searchterm'])) ? esc_html($_POST['searchterm']) : esc_html($_GET[$this -> pre . 'searchterm']); ?>" id="post-search-input" class="search-input" />
