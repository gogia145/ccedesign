<div class="wrap newsletters">
	<h2><?php _e('Offsite HTML Code', 'wp-mailinglist'); ?></h2>
	<div>
		<p><?php _e('Put the code below in the <code><HEAD></HEAD></code> section of your site', 'wp-mailinglist'); ?></p>
		...
		<p><?php _e('Use the code below to create an opt-in form on any website', 'wp-mailinglist'); ?><br/>
		<?php _e('Place the code into the HTML of your site', 'wp-mailinglist'); ?></p>
