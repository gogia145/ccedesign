...
<h3><?php _e('Additional Data', 'wp-mailinglist'); ?></h3>
	...
	<form action="" method="post" onsubmit="wpmlmanagement_savefields(this); return false;" id="subscribersavefieldsform">
        ...
        <?php if (!empty($managementformatchange) && $managementformatchange == "Y") : ?>
	        <div class="newsletters-fieldholder format">
	        	<label for="format_html" class="wpmlcustomfield"><?php _e('Email Format:', 'wp-mailinglist'); ?></label>
        ...
        <div class="wpmlsubmitholder">
            <button value="1" id="savefieldsbutton" class="<?php echo $this -> pre; ?>button ui-button-primary" type="submit" name="savefields">
